...
const I18N = {
  ru: {
    ...
    testimonials: {
      ...
      items: [{
        quote: "Сделали MVP за шесть недель. Через два месяца мы закрыли seed-раунд. Aurelyn — не подрядчик, это часть команды.",
        author: "Тимур А.",
        role: "CEO, FleetOps"
      }, {
        quote: "Я видел десятки агентств. Никто не пишет код такого качества за такие сроки. Сайт грузится 0.4 секунды.",
        author: "Алина К.",
        role: "CMO, Korium"
      }, {
        quote: "Бот, который реально окупился. Никаких \"а можно ещё фичу\" — просто работает.",
        author: "Бекзод Р.",
        role: "Founder, Asal"
      }]
    },
  ...
  en: {
    ...
    testimonials: {
      ...
      items: [{
        quote: "They shipped our MVP in six weeks. Two months later we closed our seed round. Aurelyn isn't a vendor — they're our team.",
        author: "Timur A.",
        role: "CEO, FleetOps"
      }, {
        quote: "I've seen dozens of agencies. Nobody writes code this clean at this pace. Our site loads in 400ms.",
        author: "Alina K.",
        role: "CMO, Korium"
      }, {
        quote: "A bot that actually paid for itself. No endless feature creep — it just works.",
        author: "Bekzod R.",
        role: "Founder, Asal"
      }]
    },
  ...
  uz: {
    ...
    testimonials: {
      ...
      items: [{
        quote: "MVP'ni olti haftada topshirishdi. Ikki oy o'tib seed-raundni yopdik. Aurelyn pudratchi emas — bizning jamoamiz.",
        author: "Timur A.",
        role: "CEO, FleetOps"
      }, {
        quote: "O'nlab agentlikni ko'rganman. Hech kim bunday darajada va tezlikda kod yozmaydi. Sayt 400ms'da yuklanadi.",
        author: "Alina K.",
        role: "CMO, Korium"
      }, {
        quote: "O'zini-o'zi qoplagan bot. Cheksiz \"yana bir feature\" yo'q — shunchaki ishlaydi.",
        author: "Bekzod R.",
        role: "Founder, Asal"
      }]
    },
